...
# Modified by: Danila Parnishchev

# Original repository: https://github.com/gdelugre/ida-arm-system-highlight (looks abandoned)
...
AARCH32_COPROC_REGISTERS = {
    ...
    ("p15", "c10", 0, "c2", 0): ("MAIR0",
                                 "Memory Attribute Indirection Register 0", "PRRR", "Primary Region Remap Register"),
    ("p15", "c10", 0, "c2", 1): ("MAIR1",
                                 "Memory Attribute Indirection Register 1", "NMRR", "Normal Memory Remap Register"),
...
AARCH64_SYSTEM_REGISTERS = {
    ...
    (0b011, 0b000, "c12", "c0", 0b001): ("RVBAR_EL1",
    ...
    (0b011, 0b010, "c0", "c0", 0b000): ("TEECR32_EL1", "T32EE Configuration Register"),
    # Not defined in 8.2 specifications.
    (0b011, 0b010, "c1", "c0", 0b000): ("TEEHBR32_EL1", "T32EE Handler Base Register"),
    # Not defined in 8.2 specifications.
    ...
    (0b011, 0b100, "c13", "c8", 0b000): (
        "AMEVCNTVOFF00_EL2", "Activity Monitors Event Counter Virtual Offset Registers 0"),
    (0b011, 0b100, "c13", "c8", 0b001): (
        "AMEVCNTVOFF01_EL2", "Activity Monitors Event Counter Virtual Offset Registers 0"),
    (0b011, 0b100, "c13", "c8", 0b010): (
        "AMEVCNTVOFF02_EL2", "Activity Monitors Event Counter Virtual Offset Registers 0"),
    (0b011, 0b100, "c13", "c8", 0b011): (
        "AMEVCNTVOFF03_EL2", "Activity Monitors Event Counter Virtual Offset Registers 0"),
    (0b011, 0b100, "c13", "c8", 0b100): (
        "AMEVCNTVOFF04_EL2", "Activity Monitors Event Counter Virtual Offset Registers 0"),
    (0b011, 0b100, "c13", "c8", 0b101): (
        "AMEVCNTVOFF05_EL2", "Activity Monitors Event Counter Virtual Offset Registers 0"),
    (0b011, 0b100, "c13", "c8", 0b110): (
        "AMEVCNTVOFF06_EL2", "Activity Monitors Event Counter Virtual Offset Registers 0"),
    (0b011, 0b100, "c13", "c8", 0b111): (
        "AMEVCNTVOFF07_EL2", "Activity Monitors Event Counter Virtual Offset Registers 0"),
    (0b011, 0b100, "c13", "c9", 0b000): (
        "AMEVCNTVOFF08_EL2", "Activity Monitors Event Counter Virtual Offset Registers 0"),
    (0b011, 0b100, "c13", "c9", 0b001): (
        "AMEVCNTVOFF09_EL2", "Activity Monitors Event Counter Virtual Offset Registers 0"),
    (0b011, 0b100, "c13", "c9", 0b010): (
        "AMEVCNTVOFF010_EL2", "Activity Monitors Event Counter Virtual Offset Registers 0"),
    (0b011, 0b100, "c13", "c9", 0b011): (
        "AMEVCNTVOFF011_EL2", "Activity Monitors Event Counter Virtual Offset Registers 0"),
    (0b011, 0b100, "c13", "c9", 0b100): (
        "AMEVCNTVOFF012_EL2", "Activity Monitors Event Counter Virtual Offset Registers 0"),
    (0b011, 0b100, "c13", "c9", 0b101): (
        "AMEVCNTVOFF013_EL2", "Activity Monitors Event Counter Virtual Offset Registers 0"),
    (0b011, 0b100, "c13", "c9", 0b110): (
        "AMEVCNTVOFF014_EL2", "Activity Monitors Event Counter Virtual Offset Registers 0"),
    (0b011, 0b100, "c13", "c9", 0b111): (
        "AMEVCNTVOFF015_EL2", "Activity Monitors Event Counter Virtual Offset Registers 0"),
    (0b011, 0b100, "c13", "c10", 0b000): (
        "AMEVCNTVOFF10_EL2", "Activity Monitors Event Counter Virtual Offset Registers 1"),
    (0b011, 0b100, "c13", "c10", 0b001): (
        "AMEVCNTVOFF11_EL2", "Activity Monitors Event Counter Virtual Offset Registers 1"),
    (0b011, 0b100, "c13", "c10", 0b010): (
        "AMEVCNTVOFF12_EL2", "Activity Monitors Event Counter Virtual Offset Registers 1"),
    (0b011, 0b100, "c13", "c10", 0b011): (
        "AMEVCNTVOFF13_EL2", "Activity Monitors Event Counter Virtual Offset Registers 1"),
    (0b011, 0b100, "c13", "c10", 0b100): (
        "AMEVCNTVOFF14_EL2", "Activity Monitors Event Counter Virtual Offset Registers 1"),
    (0b011, 0b100, "c13", "c10", 0b101): (
        "AMEVCNTVOFF15_EL2", "Activity Monitors Event Counter Virtual Offset Registers 1"),
    (0b011, 0b100, "c13", "c10", 0b110): (
        "AMEVCNTVOFF16_EL2", "Activity Monitors Event Counter Virtual Offset Registers 1"),
    (0b011, 0b100, "c13", "c10", 0b111): (
        "AMEVCNTVOFF17_EL2", "Activity Monitors Event Counter Virtual Offset Registers 1"),
    (0b011, 0b100, "c13", "c11", 0b000): (
        "AMEVCNTVOFF18_EL2", "Activity Monitors Event Counter Virtual Offset Registers 1"),
    (0b011, 0b100, "c13", "c11", 0b001): (
        "AMEVCNTVOFF19_EL2", "Activity Monitors Event Counter Virtual Offset Registers 1"),
    (0b011, 0b100, "c13", "c11", 0b010): (
        "AMEVCNTVOFF110_EL2", "Activity Monitors Event Counter Virtual Offset Registers 1"),
    (0b011, 0b100, "c13", "c11", 0b011): (
        "AMEVCNTVOFF111_EL2", "Activity Monitors Event Counter Virtual Offset Registers 1"),
    (0b011, 0b100, "c13", "c11", 0b100): (
        "AMEVCNTVOFF112_EL2", "Activity Monitors Event Counter Virtual Offset Registers 1"),
    (0b011, 0b100, "c13", "c11", 0b101): (
        "AMEVCNTVOFF113_EL2", "Activity Monitors Event Counter Virtual Offset Registers 1"),
    (0b011, 0b100, "c13", "c11", 0b110): (
        "AMEVCNTVOFF114_EL2", "Activity Monitors Event Counter Virtual Offset Registers 1"),
    (0b011, 0b100, "c13", "c11", 0b111): (
        "AMEVCNTVOFF115_EL2", "Activity Monitors Event Counter Virtual Offset Registers 1"),
    ...
    (0b011, 0b000, "c12", "c8", 0b010): (
        "ICC_HPPIR0_EL1", "Interrupt Controller Virtual Highest Priority Pending Interrupt Register 0"),
    (0b011, 0b000, "c12", "c12", 0b010): (
        "ICC_HPPIR1_EL1", "Interrupt Controller Virtual Highest Priority Pending Interrupt Register 1"),
    (0b011, 0b000, "c12", "c8", 0b000): (
        "ICC_IAR0_EL1", "Interrupt Controller Virtual Interrupt Acknowledge Register 0"),
    (0b011, 0b000, "c12", "c12", 0b000): ("ICC_IAR1_EL1", "Interrupt Controller Interrupt Acknowledge Register 1"),
    (0b011, 0b000, "c12", "c12", 0b110): (
        "ICC_IGRPEN0_EL1", "Interrupt Controller Virtual Interrupt Group 0 Enable register"),
    (0b011, 0b000, "c12", "c12", 0b111): ("ICC_IGRPEN1_EL1", "Interrupt Controller Interrupt Group 1 Enable register"),
    (0b011, 0b110, "c12", "c12", 0b111): (
    ...
    (0b011, 0b000, "c12", "c11", 0b011): ("ICC_RPR_EL1", "Interrupt Controller Running Priority Register"),
    # Not defined in 8.2 specifications.
    (0b011, 0b000, "c12", "c11", 0b000): (
        "ICC_SEIEN_EL1", "Interrupt Controller System Error Interrupt Enable Register"),
    (0b011, 0b000, "c12", "c11", 0b111): (
        "ICC_SGI0R_EL1", "Interrupt Controller Software Generated Interrupt Group 0 Register"),
    (0b011, 0b000, "c12", "c11", 0b101): (
    ...
    (0b011, 0b100, "c12", "c8", 0b000): (
        "ICH_AP0R0_EL2", "Interrupt Controller Hyp Active Priorities Group 0 Register 0"),
    (0b011, 0b100, "c12", "c8", 0b001): (
        "ICH_AP0R1_EL2", "Interrupt Controller Hyp Active Priorities Group 0 Register 1"),
    (0b011, 0b100, "c12", "c8", 0b010): (
        "ICH_AP0R2_EL2", "Interrupt Controller Hyp Active Priorities Group 0 Register 2"),
    (0b011, 0b100, "c12", "c8", 0b011): (
        "ICH_AP0R3_EL2", "Interrupt Controller Hyp Active Priorities Group 0 Register 3"),
    (0b011, 0b100, "c12", "c9", 0b000): (
        "ICH_AP1R0_EL2", "Interrupt Controller Hyp Active Priorities Group 1 Register 0"),
    (0b011, 0b100, "c12", "c9", 0b001): (
        "ICH_AP1R1_EL2", "Interrupt Controller Hyp Active Priorities Group 1 Register 1"),
    (0b011, 0b100, "c12", "c9", 0b010): (
        "ICH_AP1R2_EL2", "Interrupt Controller Hyp Active Priorities Group 1 Register 2"),
    (0b011, 0b100, "c12", "c9", 0b011): (
        "ICH_AP1R3_EL2", "Interrupt Controller Hyp Active Priorities Group 1 Register 3"),
    (0b011, 0b100, "c12", "c11", 0b011): ("ICH_EISR_EL2", "Interrupt Controller End of Interrupt Status Register"),
    (0b011, 0b100, "c12", "c11", 0b101): ("ICH_ELSR_EL2", "Interrupt Controller Empty List Register Status Register"),
    # Named ICH_ELRSR_EL2 in 8.2 specifications.
    ...
    (0b011, 0b100, "c12", "c9", 0b100): (
        "ICH_VSEIR_EL2", "Interrupt Controller Virtual System Error Interrupt Register"),
    # Not defined in 8.2 specifications.
    ...
    (0b011, 0b000, "c12", "c8", 0b100): (
        "ICV_AP0R0_EL1", "Interrupt Controller Virtual Active Priorities Group 0 Registers"),
    (0b011, 0b000, "c12", "c8", 0b101): (
        "ICV_AP0R1_EL1", "Interrupt Controller Virtual Active Priorities Group 0 Registers"),
    (0b011, 0b000, "c12", "c8", 0b110): (
        "ICV_AP0R2_EL1", "Interrupt Controller Virtual Active Priorities Group 0 Registers"),
    (0b011, 0b000, "c12", "c8", 0b111): (
        "ICV_AP0R3_EL1", "Interrupt Controller Virtual Active Priorities Group 0 Registers"),
    (0b011, 0b000, "c12", "c9", 0b000): (
        "ICV_AP1R0_EL1", "Interrupt Controller Virtual Active Priorities Group 1 Registers"),
    (0b011, 0b000, "c12", "c9", 0b001): (
        "ICV_AP1R1_EL1", "Interrupt Controller Virtual Active Priorities Group 1 Registers"),
    (0b011, 0b000, "c12", "c9", 0b010): (
        "ICV_AP1R2_EL1", "Interrupt Controller Virtual Active Priorities Group 1 Registers"),
    (0b011, 0b000, "c12", "c9", 0b011): (
        "ICV_AP1R3_EL1", "Interrupt Controller Virtual Active Priorities Group 1 Registers"),
...
# Aarch64 system coprocessor registers.
AARCH64_SYSTEM_COPROC_REGISTERS = {
    ...
    (4, "c8", "c0", 1): ("TLBI IPAS2E1IS, TLBI IPAS2E1ISNXS",
                         "TLB Invalidate by Intermediate Physical Address, Stage 2, EL1, Inner Shareable"),
    (4, "c8", "c4", 0): ("TLBI IPAS2E1OS, TLBI IPAS2E1OSNXS",
    ...
    (4, "c8", "c0", 5): ("TLBI IPAS2LE1IS, TLBI IPAS2LE1ISNXS",
                         "TLB Invalidate by Intermediate Physical Address, Stage 2, Last level, EL1, Inner Shareable"),
    (4, "c8", "c4", 4): ("TLBI IPAS2LE1OS, TLBI IPAS2LE1OSNXS",
...
AARCH32_COPROC_FIELDS = {
    ...
    "HSCTLR": {
        ...
        2: ("C", "Cache Enable"),
        3: ("SA/nTLSMD",
            "Stack alignment check or No Trap Load Multiple and Store Multiple to "
...
AARCH64_SYSREG_FIELDS = {
    ...
    "FPCR": {
        ...
        2: ("NEP",
            "Controls how the output elements other than the lowest element of the vector are determined for Advanced "
    ...
    "SCR_EL3": {
        ...
        11: ("ST",
             "Traps Secure EL1 accesses to the Counter-timer Physical Secure timer registers to EL3, from AArch64 "
             "state only."),
        12: ("TWI", "Traps WFI instructions to Monitor mode"),
        13: ("TWE", "Traps WFE instructions to Monitor mode"),
    ...
    "SCTLR_EL1": {
        ...
        12: ("I", "Instruction cache Enable"),
        13: ("EnDB",
             "Enable pointer authentication (using the APDBKey_EL1 key) of instruction addresses in the EL1&0 "
             "translation regime"),
        ...
        27: ("EnDA",
             "Enable pointer authentication (using the APDAKey_EL1 key) of instruction addresses in the EL1&0 "
             "translation regime"),
        ...
        30: ("EnIB",
             "Enable pointer authentication (using the APIBKey_EL1 key) of instruction addresses in the EL1&0 "
             "translation regime"),
        31: ("EnIA",
             "Enable pointer authentication (using the APIAKey_EL1 key) of instruction addresses in the EL1&0 "
             "translation regime"),
    ...
    "SCTLR_EL2": {
        ...
        12: ("I", "Instruction cache Enable"),
        13: ("EnDB",
             "Enable pointer authentication (using the APDBKey_EL1 key) of instruction addresses in the EL2 or EL2&0 "
             "translation regime"),
        ...
        27: ("EnDA",
             "Enable pointer authentication (using the APDAKey_EL1 key) of instruction addresses in the EL2 or EL2&0 "
             "translation regime"),
        28: ("nTLSMD", "No Trap Load Multiple and Store Multiple to Device-nGRE/Device-nGnRE/Device-nGnRnE memory"),
        29: ("LSMAOE", "Load Multiple and Store Multiple Atomicity and Ordering Enable"),
        30: ("EnIB",
             "Enable pointer authentication (using the APIBKey_EL1 key) of instruction addresses in the EL2 or EL2&0 "
             "translation regime"),
        31: ("EnIA",
             "Enable pointer authentication (using the APIAKey_EL1 key) of instruction addresses in the EL2 or EL2&0 "
             "translation regime"),
        35: ("BT0", "PAC Branch Type compatibility at EL0"),
    ...
    "SCTLR_EL3": {
        ...
        12: ("I", "Instruction cache Enable"),
        13: ("EnDB",
             "Enable pointer authentication (using the APDBKey_EL1 key) of instruction addresses in the EL3 "
             "translation regime"),
        19: ("WXN", "Write permission implies XN"),
        21: ("IESB", "Implicit Error Synchronization event enable"),
        22: ("EIS", "Exception Entry is Context Synchronizing"),
        25: ("EE", "Exception Endianness"),
        27: ("EnDA",
             "Enable pointer authentication (using the APDAKey_EL1 key) of instruction addresses in the EL3 "
             "translation regime"),
        30: ("EnIB",
             "Enable pointer authentication (using the APIBKey_EL1 key) of instruction addresses in the EL3 "
             "translation regime"),
        31: ("EnIA",
             "Enable pointer authentication (using the APIAKey_EL1 key) of instruction addresses in the EL3 "
             "translation regime"),
    ...
    "CPACR_EL1": {
        ...
        (20, 2): ("FPEN",
                  "Traps execution at EL1 and EL0 of instructions that access the Advanced SIMD and floating-point "
                  "registers"),
    ...
    "CTR_EL0": {
        ...
        (16, 4): (
            "DminLine",
            "Log2 of the number of words in the smallest cache line of all the data caches and unified caches"),
...
def is_interrupt_return(ea):
    ...
    return (len(mnem) > 0 and (mnem in ('ERET', 'RFE') or
                               ...
                               (mnem[0:4] in ("SUBS", "MOVS") and
                                print_operand(ea, 0) == "PC" and
                                print_operand(ea, 1) == "LR")))
...
def is_same_register(reg0, reg1):
    return (reg0 == reg1) or (current_arch == 'aarch64' and reg0[1:] == reg1[1:] and (
            (reg0[0] == 'W' and reg1[0] == 'X') or (reg0[0] == 'X' and reg1[0] == 'W')))


def backtrack_can_skip_insn(ea, reg):
    mnem = print_insn_mnem(ea)
    if mnem in ("NOP", "ISB", "DSB", "DMB", "MSR", "MCR", "MCRR", "MCRR", "MCRR2", "CMP") or mnem[0:3] in (
            "STR", "STM"):
        return True
    ...
    if mnem in ("LDR", "MRS", "ORR", "AND", "EOR", "BIC", "MOV", "MOVK", "MOVT", "LSR", "LSL", "ADD",
                "SUB") and not is_same_register(print_operand(ea, 0), reg):
        return True
...
def backtrack_fields(ea, reg, fields, cmt_type=None):
    cmt_formatter = {
        "LDR": lambda bts: "Set bits %s" % ", ".join("{} ({})".format(name, desc) for (name, desc) in bts),
        "MOV": lambda bts: "Set bits %s" % ", ".join("{} ({})".format(name, desc) for (name, desc) in bts),
        "ORR": lambda bts: "Set bit %s" % ", ".join("{} ({})".format(name, desc) for (name, desc) in bts),
        "BIC": lambda bts: "Clear bit %s" % ", ".join(desc for (name, desc) in bts),
        "AND": lambda bts: "Clear bit %s" % ", \n".join(desc for (name, desc) in bts),
    }
...
def track_fields(ea, reg, fields):
    while True:
        ...
        if next_mnem[0:3] in ("TST", "TEQ", "CMP") and is_same_register(print_operand(ea, 0), reg) and \
...
def identify_register(ea, access, sig, known_regs, cpu_reg=None, known_fields=None):
    ...
    if desc:
        ...
        # Try to resolve fields during write or test operation.
...
def print_summary():
    ...
    for category, addrs in summary_info.items():
        if len(addrs) == 0:
            continue
        print(
            "  {:<24}: {}".format(category, ", ".join(hex(addr) if isinstance(addr, int) else addr for addr in addrs)))
